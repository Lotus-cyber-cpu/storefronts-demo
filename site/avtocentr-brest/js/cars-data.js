...
(function (global) {
  ...
  const SEED_CARS = [
    { id: 'toyota-camry-2020', brand: 'Toyota', model: 'Camry', year: 2020, price: 54900, mileage: 61000, country: 'Германия', fuel: 'Бензин', trans: 'Автомат', engine: '2.5 л, 181 л.с.', drive: 'Передний', color: 'Чёрный', vin: true, warranty: true, report: true, status: 'instock', hue: [206, 230], img: 'assets/cars/toyota-camry-2020.jpg' },
    { id: 'volkswagen-passat-2019', brand: 'Volkswagen', model: 'Passat B8', year: 2019, price: 41500, mileage: 88000, country: 'Литва', fuel: 'Дизель', trans: 'Автомат', engine: '2.0 л, 150 л.с.', drive: 'Передний', color: 'Серый', vin: true, warranty: true, report: true, status: 'instock', hue: [14, 40], img: 'assets/cars/volkswagen-passat-2019.jpg' },
    { id: 'skoda-octavia-2021', brand: 'Skoda', model: 'Octavia', year: 2021, price: 38900, mileage: 34000, country: 'Беларусь (в наличии)', fuel: 'Бензин', trans: 'Механика', engine: '1.4 л, 150 л.с.', drive: 'Передний', color: 'Белый', vin: true, warranty: true, report: true, status: 'instock', hue: [150, 190], img: 'assets/cars/skoda-octavia-2021.jpg' },
    { id: 'bmw-520d-2018', brand: 'BMW', model: '520d', year: 2018, price: 49900, mileage: 102000, country: 'Германия', fuel: 'Дизель', trans: 'Автомат', engine: '2.0 л, 190 л.с.', drive: 'Задний', color: 'Синий', vin: true, warranty: true, report: true, status: 'reserved', hue: [230, 260], img: 'assets/cars/bmw-520d-2018.jpg' },
    { id: 'kia-sportage-2022', brand: 'Kia', model: 'Sportage', year: 2022, price: 62900, mileage: 21000, country: 'Польша', fuel: 'Бензин', trans: 'Автомат', engine: '1.6 л, 150 л.с.', drive: 'Полный', color: 'Красный', vin: true, warranty: true, report: true, status: 'instock', hue: [356, 20], img: 'assets/cars/kia-sportage-2022.jpg' },
    { id: 'hyundai-tucson-2020', brand: 'Hyundai', model: 'Tucson', year: 2020, price: 46900, mileage: 57000, country: 'Литва', fuel: 'Дизель', trans: 'Автомат', engine: '2.0 л, 185 л.с.', drive: 'Полный', color: 'Серебристый', vin: true, warranty: true, report: true, status: 'order', hue: [200, 220], img: 'assets/cars/hyundai-tucson-2020.jpg' },
    { id: 'mercedes-e200-2017', brand: 'Mercedes-Benz', model: 'E200', year: 2017, price: 47500, mileage: 121000, country: 'Германия', fuel: 'Бензин', trans: 'Автомат', engine: '2.0 л, 184 л.с.', drive: 'Задний', color: 'Чёрный', vin: true, warranty: true, report: true, status: 'instock', hue: [222, 250], img: 'assets/cars/mercedes-e200-2017.jpg' },
    { id: 'renault-koleos-2019', brand: 'Renault', model: 'Koleos', year: 2019, price: 36900, mileage: 74000, country: 'Польша', fuel: 'Дизель', trans: 'Вариатор', engine: '2.0 л, 177 л.с.', drive: 'Полный', color: 'Коричневый', vin: true, warranty: true, report: true, status: 'instock', hue: [28, 50], img: 'assets/cars/renault-koleos-2019.jpg' },
    { id: 'nissan-qashqai-2021', brand: 'Nissan', model: 'Qashqai', year: 2021, price: 43900, mileage: 39000, country: 'Беларусь (в наличии)', fuel: 'Бензин', trans: 'Вариатор', engine: '1.3 л, 140 л.с.', drive: 'Передний', color: 'Белый', vin: true, warranty: true, report: true, status: 'sold', hue: [190, 210], img: 'assets/cars/nissan-qashqai-2021.jpg' },
    { id: 'mazda-cx5-2021', brand: 'Mazda', model: 'CX-5', year: 2021, price: 45900, mileage: 48000, country: 'Германия', fuel: 'Бензин', trans: 'Автомат', engine: '2.5 л, 194 л.с.', drive: 'Полный', color: 'Серый', vin: true, warranty: true, report: true, status: 'instock', hue: [268, 296], img: 'assets/cars/mazda-cx5-2021.jpg' },
  ];
